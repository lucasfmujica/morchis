...
import CategoriasBreakdownClient from './categorias-breakdown-client';

export default async function CategoriasBreakdownPage() {
  ...
  return (
    <CategoriasBreakdownClient
      profile={profile as Parameters<typeof CategoriasBreakdownClient>[0]['profile']}
