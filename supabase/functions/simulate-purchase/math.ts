// Pure projection math for simulate-purchase — NO imports, runs under Node/Vitest.
// All amounts handed in here are already normalised to ARS by the handler.
...
export function computeProjection(txs: PTx[], rules: PRule[], today: Date) {
